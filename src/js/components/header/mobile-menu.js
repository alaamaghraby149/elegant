...
class MobileMenu extends HTMLElement {
    ...
    render() {
        this.innerHTML = `
  <div class="container fly-list z-[1000000] transition-all duration-300 ease-in-out absolute top-0 left-[-716px] w-[85%] bg-white pt-[24px] h-screen flex flex-col shadow-xl">
    <div class="flex flex-col">
      <div class="flex justify-between">
        <div class="navigation__logo">
          <a class="font-poppins font-medium text-[16px] leading-[24px] flex items-center" href="#">
            3legant.
          </a>
        </div>
      ...
      <ul class="navigation__list flex flex-col gap-[16px]">
        <li class="text-black pb-[8px] border-b border-gray-200">
          <a href="#">Home</a>
        </li>
    ...
    <div class="mb-[24px] mt-auto">
      <ul class="flex flex-col gap-[8px]">
        <li class="flex justify-between gap-[10px] border-b border-gray-200 pb-[8px] h-[40px]">
          <a class="text-gray-500 text-[18px] font-medium tracking-[-0.4px] font-inter" href="#">
            Cart
          </a>
          ...
          <div class="flex items-center gap-[5px]">
            ...
            <span
              class="text-white cursor-pointer flex items-center justify-center bg-black h-[20px] font-bold text-[12px] leading-[10px] py-[5px] px-[6px] w-[20px] rounded-full">
              2
            </span>
          </div>
        </li>
